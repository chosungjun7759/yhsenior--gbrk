...
import { User, LeaveRequest, Role, LEAVE_TYPE_LABELS, LeaveType } from "../types";
        ...
        <div key={req.id} className="border border-slate-200 rounded-xl overflow-hidden bg-white">
          ...
          >
            <div className="flex items-center gap-3">
              <span className="text-xs font-black bg-amber-100 text-amber-700 border border-amber-200 px-2 py-0.5 rounded">
          ...
          {expanded === req.id && (
            <div className="border-t border-slate-100 px-4 py-4 bg-slate-50 space-y-3">
              ...
              {/* 연가인 경우 인수인계서 뷰어 추가 */}
              {req.leaveType === LeaveType.ANNUAL && <HandoverViewer request={req} />}
